    ...
    >
      ...
      <div className="flex items-center gap-3 flex-1 relative z-10">
        <div className="relative flex-shrink-0">
          ...
          {/* Equaliser */}
          <div className="absolute -bottom-1 -right-1 flex items-end gap-[2px] rounded px-1 py-0.5">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex justify-between">
            ...
            <div className="flex items-center gap-1.5 text-xs text-muted-foreground/40 group-hover:text-accent/70 transition-colors whitespace-nowrap">
              <span>View on Spotify</span>
              <ExternalLink className="w-3.5 h-3.5 text-muted-foreground/30 group-hover:text-accent/60 transition-colors" />
            </div>
          </div>
